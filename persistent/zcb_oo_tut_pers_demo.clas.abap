class ZCB_OO_TUT_PERS_DEMO definition
  public
...
public section.
*"* public components of class ZCB_OO_TUT_PERS_DEMO
*"* do not include other source files here!!!
  ...
  methods CREATE_PERSISTENT
    ...
    returning
      value(RESULT) type ref to ZCL_OO_TUT_PERS_DEMO
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_OO_TUT_PERS_DEMO
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_OO_TUT_PERS_DEMO .
  types:
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_OO_TUT_PERS_DEMO
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_OO_TUT_PERS_DEMO IMPLEMENTATION.
...
*      RETURNING RESULT TYPE REF TO ZCL_OO_TUT_PERS_DEMO
************************************************************************
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_OO_TUT_PERS_DEMO,
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_OO_TUT_PERS_DEMO.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_OO_TUT_PERS_DEMO.
