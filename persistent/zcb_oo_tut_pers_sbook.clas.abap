class ZCB_OO_TUT_PERS_SBOOK definition
  public
...
public section.
*"* public components of class ZCB_OO_TUT_PERS_SBOOK
*"* do not include other source files here!!!

  methods CREATE_PERSISTENT
    importing
      !I_AGENCYNUM type S_AGNCYNUM optional
      !I_BOOKID type S_BOOK_ID
      !I_CANCELLED type S_CANCEL optional
      !I_CARRID type S_CARR_ID
      !I_CLASS type S_CLASS optional
      !I_CONNID type S_CONN_ID
      !I_COUNTER type S_COUNTNUM optional
      !I_CUSTOMID type S_CUSTOMER optional
      !I_CUSTTYPE type S_CUSTTYPE optional
      !I_FLDATE type S_DATE
      !I_FORCURAM type S_F_CUR_PR optional
      !I_FORCURKEY type S_CURR optional
      !I_INVOICE type S_INVFLAG optional
      !I_LOCCURAM type S_L_CUR_PR optional
      !I_LOCCURKEY type S_CURRCODE optional
      !I_LUGGWEIGHT type S_LUGWEIGH optional
      !I_ORDER_DATE type S_BDATE optional
      !I_PASSBIRTH type S_BIRTHDAT optional
      !I_PASSFORM type S_FORM optional
      !I_PASSNAME type S_PASSNAME optional
      !I_RESERVED type S_RESERV optional
      !I_SMOKER type S_SMOKER optional
      !I_WUNIT type S_WEIUNIT optional
    returning
      value(RESULT) type ref to ZCL_OO_TUT_PERS_SBOOK
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_OO_TUT_PERS_SBOOK
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_OO_TUT_PERS_SBOOK .
  types:
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_OO_TUT_PERS_SBOOK
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_OO_TUT_PERS_SBOOK IMPLEMENTATION.


method CREATE_PERSISTENT.
***BUILD 090501
*      IMPORTING I_BOOKID TYPE S_BOOK_ID
*      IMPORTING I_CARRID TYPE S_CARR_ID
*      IMPORTING I_CONNID TYPE S_CONN_ID
*      IMPORTING I_FLDATE TYPE S_DATE
*      IMPORTING I_AGENCYNUM TYPE S_AGNCYNUM
*      IMPORTING I_CANCELLED TYPE S_CANCEL
*      IMPORTING I_CLASS TYPE S_CLASS
*      IMPORTING I_COUNTER TYPE S_COUNTNUM
*      IMPORTING I_CUSTOMID TYPE S_CUSTOMER
*      IMPORTING I_CUSTTYPE TYPE S_CUSTTYPE
*      IMPORTING I_FORCURAM TYPE S_F_CUR_PR
*      IMPORTING I_FORCURKEY TYPE S_CURR
*      IMPORTING I_INVOICE TYPE S_INVFLAG
*      IMPORTING I_LOCCURAM TYPE S_L_CUR_PR
*      IMPORTING I_LOCCURKEY TYPE S_CURRCODE
*      IMPORTING I_LUGGWEIGHT TYPE S_LUGWEIGH
*      IMPORTING I_ORDER_DATE TYPE S_BDATE
*      IMPORTING I_PASSBIRTH TYPE S_BIRTHDAT
*      IMPORTING I_PASSFORM TYPE S_FORM
*      IMPORTING I_PASSNAME TYPE S_PASSNAME
*      IMPORTING I_RESERVED TYPE S_RESERV
*      IMPORTING I_SMOKER TYPE S_SMOKER
*      IMPORTING I_WUNIT TYPE S_WEIUNIT
*      RETURNING RESULT TYPE REF TO ZCL_OO_TUT_PERS_SBOOK
************************************************************************
...
*<  Generated from mapping:
          THE_OBJECT->BOOKID = I_BOOKID.
          THE_OBJECT->CARRID = I_CARRID.
          THE_OBJECT->CONNID = I_CONNID.
          THE_OBJECT->FLDATE = I_FLDATE.
          THE_OBJECT->AGENCYNUM = I_AGENCYNUM.
          THE_OBJECT->CANCELLED = I_CANCELLED.
          THE_OBJECT->CLASS = I_CLASS.
          THE_OBJECT->COUNTER = I_COUNTER.
          THE_OBJECT->CUSTOMID = I_CUSTOMID.
          THE_OBJECT->CUSTTYPE = I_CUSTTYPE.
          THE_OBJECT->FORCURAM = I_FORCURAM.
          THE_OBJECT->FORCURKEY = I_FORCURKEY.
          THE_OBJECT->INVOICE = I_INVOICE.
          THE_OBJECT->LOCCURAM = I_LOCCURAM.
          THE_OBJECT->LOCCURKEY = I_LOCCURKEY.
          THE_OBJECT->LUGGWEIGHT = I_LUGGWEIGHT.
          THE_OBJECT->ORDER_DATE = I_ORDER_DATE.
          THE_OBJECT->PASSBIRTH = I_PASSBIRTH.
          THE_OBJECT->PASSFORM = I_PASSFORM.
          THE_OBJECT->PASSNAME = I_PASSNAME.
          THE_OBJECT->RESERVED = I_RESERVED.
          THE_OBJECT->SMOKER = I_SMOKER.
          THE_OBJECT->WUNIT = I_WUNIT.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_BOOKID = BUSINESS_KEY-BOOKID
                 I_CARRID = BUSINESS_KEY-CARRID
...
*<Generated from mapping:
  E_BUSINESS_KEY-BOOKID  = I_DB_DATA-BOOKID.
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_OO_TUT_PERS_SBOOK,
...
*<  Generated from mapping:
    OBJECT_DATA_ITEM-AGENCYNUM = THE_OBJECT->AGENCYNUM.
    OBJECT_DATA_ITEM-BOOKID = THE_OBJECT->BOOKID.
    OBJECT_DATA_ITEM-CANCELLED = THE_OBJECT->CANCELLED.
    OBJECT_DATA_ITEM-CARRID = THE_OBJECT->CARRID.
    OBJECT_DATA_ITEM-CLASS = THE_OBJECT->CLASS.
    OBJECT_DATA_ITEM-CONNID = THE_OBJECT->CONNID.
    OBJECT_DATA_ITEM-COUNTER = THE_OBJECT->COUNTER.
    OBJECT_DATA_ITEM-CUSTOMID = THE_OBJECT->CUSTOMID.
    OBJECT_DATA_ITEM-CUSTTYPE = THE_OBJECT->CUSTTYPE.
    OBJECT_DATA_ITEM-FLDATE = THE_OBJECT->FLDATE.
    OBJECT_DATA_ITEM-FORCURAM = THE_OBJECT->FORCURAM.
    OBJECT_DATA_ITEM-FORCURKEY = THE_OBJECT->FORCURKEY.
    OBJECT_DATA_ITEM-INVOICE = THE_OBJECT->INVOICE.
    OBJECT_DATA_ITEM-LOCCURAM = THE_OBJECT->LOCCURAM.
    OBJECT_DATA_ITEM-LOCCURKEY = THE_OBJECT->LOCCURKEY.
    OBJECT_DATA_ITEM-LUGGWEIGHT = THE_OBJECT->LUGGWEIGHT.
    OBJECT_DATA_ITEM-ORDER_DATE = THE_OBJECT->ORDER_DATE.
    OBJECT_DATA_ITEM-PASSBIRTH = THE_OBJECT->PASSBIRTH.
    OBJECT_DATA_ITEM-PASSFORM = THE_OBJECT->PASSFORM.
    OBJECT_DATA_ITEM-PASSNAME = THE_OBJECT->PASSNAME.
    OBJECT_DATA_ITEM-RESERVED = THE_OBJECT->RESERVED.
    OBJECT_DATA_ITEM-SMOKER = THE_OBJECT->SMOKER.
    OBJECT_DATA_ITEM-WUNIT = THE_OBJECT->WUNIT.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'AGENCYNUM'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'AGENCYNUM'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'BOOKID'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'BOOKID'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CANCELLED'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CANCELLED'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CLASS'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CLASS'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'COUNTER'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'COUNTER'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CUSTOMID'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CUSTOMID'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CUSTTYPE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CUSTTYPE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'FORCURAM'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'FORCURAM'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'FORCURKEY'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'FORCURKEY'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'INVOICE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'INVOICE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'LOCCURAM'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'LOCCURAM'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'LOCCURKEY'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'LOCCURKEY'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'LUGGWEIGHT'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'LUGGWEIGHT'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'ORDER_DATE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ORDER_DATE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'PASSBIRTH'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'PASSBIRTH'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'PASSFORM'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'PASSFORM'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'PASSNAME'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'PASSNAME'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'RESERVED'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'RESERVED'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'SMOKER'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'SMOKER'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'WUNIT'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SBOOK'.
    MAP_ATT_INFO-FIELD_NAME1  = 'WUNIT'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_OO_TUT_PERS_SBOOK.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->AGENCYNUM,
             THE_OBJECT->BOOKID,
             THE_OBJECT->CANCELLED,
             THE_OBJECT->CARRID,
             THE_OBJECT->CLASS,
             THE_OBJECT->CONNID,
             THE_OBJECT->COUNTER,
             ...
             THE_OBJECT->FLDATE,
             THE_OBJECT->FORCURAM,
             THE_OBJECT->FORCURKEY,
             THE_OBJECT->INVOICE,
             THE_OBJECT->LOCCURAM,
             THE_OBJECT->LOCCURKEY,
             THE_OBJECT->LUGGWEIGHT,
             THE_OBJECT->ORDER_DATE,
             THE_OBJECT->PASSBIRTH,
             THE_OBJECT->PASSFORM,
             THE_OBJECT->PASSNAME,
             THE_OBJECT->RESERVED,
             THE_OBJECT->SMOKER,
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type SBOOK.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_SBOOK> type SBOOK.
*>
...
*   * error handling
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_SBOOK>.

*< Generated from mapping:
    DB_DATA-AGENCYNUM = <FS_DB_SBOOK>-AGENCYNUM.
    DB_DATA-BOOKID = <FS_DB_SBOOK>-BOOKID.
    DB_DATA-CANCELLED = <FS_DB_SBOOK>-CANCELLED.
    DB_DATA-CARRID = <FS_DB_SBOOK>-CARRID.
    DB_DATA-CLASS = <FS_DB_SBOOK>-CLASS.
    DB_DATA-CONNID = <FS_DB_SBOOK>-CONNID.
    DB_DATA-COUNTER = <FS_DB_SBOOK>-COUNTER.
    DB_DATA-CUSTOMID = <FS_DB_SBOOK>-CUSTOMID.
    DB_DATA-CUSTTYPE = <FS_DB_SBOOK>-CUSTTYPE.
    DB_DATA-FLDATE = <FS_DB_SBOOK>-FLDATE.
    DB_DATA-FORCURAM = <FS_DB_SBOOK>-FORCURAM.
    DB_DATA-FORCURKEY = <FS_DB_SBOOK>-FORCURKEY.
    DB_DATA-INVOICE = <FS_DB_SBOOK>-INVOICE.
    DB_DATA-LOCCURAM = <FS_DB_SBOOK>-LOCCURAM.
    DB_DATA-LOCCURKEY = <FS_DB_SBOOK>-LOCCURKEY.
    DB_DATA-LUGGWEIGHT = <FS_DB_SBOOK>-LUGGWEIGHT.
    DB_DATA-ORDER_DATE = <FS_DB_SBOOK>-ORDER_DATE.
    DB_DATA-PASSBIRTH = <FS_DB_SBOOK>-PASSBIRTH.
    DB_DATA-PASSFORM = <FS_DB_SBOOK>-PASSFORM.
    DB_DATA-PASSNAME = <FS_DB_SBOOK>-PASSNAME.
    DB_DATA-RESERVED = <FS_DB_SBOOK>-RESERVED.
    DB_DATA-SMOKER = <FS_DB_SBOOK>-SMOKER.
    DB_DATA-WUNIT = <FS_DB_SBOOK>-WUNIT.
*>
...
*< Generated from mapping:
  select * from SBOOK
           ...
           where SBOOK~BOOKID = I_BUSINESS_KEY_TAB-BOOKID
             and SBOOK~CARRID = I_BUSINESS_KEY_TAB-CARRID
             and SBOOK~CONNID = I_BUSINESS_KEY_TAB-CONNID
             and SBOOK~FLDATE = I_BUSINESS_KEY_TAB-FLDATE.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-BOOKID = BUSINESS_KEY-BOOKID.
...
* * SBOOK: internal tables for mass operation
  data DB_ITB_SBOOK type STANDARD TABLE OF SBOOK.
  data DB_UTB_SBOOK type STANDARD TABLE OF SBOOK.
  data DB_DTB_SBOOK type STANDARD TABLE OF SBOOK.

* * SBOOK: headlines for tables
  data DB_ILN_SBOOK type SBOOK.
  data DB_ULN_SBOOK type SBOOK.
  data DB_DLN_SBOOK type SBOOK.
...
*< Generated from mapping:
   ...
   DB_ILN_SBOOK-AGENCYNUM = <FS_INSERT>-AGENCYNUM.

   DB_ILN_SBOOK-CANCELLED = <FS_INSERT>-CANCELLED.

   DB_ILN_SBOOK-CLASS = <FS_INSERT>-CLASS.

   DB_ILN_SBOOK-COUNTER = <FS_INSERT>-COUNTER.
   DB_ILN_SBOOK-CUSTOMID = <FS_INSERT>-CUSTOMID.
   DB_ILN_SBOOK-CUSTTYPE = <FS_INSERT>-CUSTTYPE.

   DB_ILN_SBOOK-FORCURAM = <FS_INSERT>-FORCURAM.
   DB_ILN_SBOOK-FORCURKEY = <FS_INSERT>-FORCURKEY.
   DB_ILN_SBOOK-INVOICE = <FS_INSERT>-INVOICE.
   DB_ILN_SBOOK-LOCCURAM = <FS_INSERT>-LOCCURAM.
   DB_ILN_SBOOK-LOCCURKEY = <FS_INSERT>-LOCCURKEY.
   DB_ILN_SBOOK-LUGGWEIGHT = <FS_INSERT>-LUGGWEIGHT.
   DB_ILN_SBOOK-ORDER_DATE = <FS_INSERT>-ORDER_DATE.
   DB_ILN_SBOOK-PASSBIRTH = <FS_INSERT>-PASSBIRTH.
   DB_ILN_SBOOK-PASSFORM = <FS_INSERT>-PASSFORM.
   DB_ILN_SBOOK-PASSNAME = <FS_INSERT>-PASSNAME.
   DB_ILN_SBOOK-RESERVED = <FS_INSERT>-RESERVED.
   DB_ILN_SBOOK-SMOKER = <FS_INSERT>-SMOKER.
   DB_ILN_SBOOK-WUNIT = <FS_INSERT>-WUNIT.


   DB_ILN_SBOOK-BOOKID = <FS_INSERT>-BOOKID.
   DB_ILN_SBOOK-CARRID = <FS_INSERT>-CARRID.
   DB_ILN_SBOOK-CONNID = <FS_INSERT>-CONNID.
   DB_ILN_SBOOK-FLDATE = <FS_INSERT>-FLDATE.
   append DB_ILN_SBOOK to DB_ITB_SBOOK.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_SBOOK-AGENCYNUM = <FS_UPDATE>-AGENCYNUM.

   DB_ULN_SBOOK-CANCELLED = <FS_UPDATE>-CANCELLED.

   DB_ULN_SBOOK-CLASS = <FS_UPDATE>-CLASS.

   DB_ULN_SBOOK-COUNTER = <FS_UPDATE>-COUNTER.
   DB_ULN_SBOOK-CUSTOMID = <FS_UPDATE>-CUSTOMID.
   DB_ULN_SBOOK-CUSTTYPE = <FS_UPDATE>-CUSTTYPE.

   DB_ULN_SBOOK-FORCURAM = <FS_UPDATE>-FORCURAM.
   DB_ULN_SBOOK-FORCURKEY = <FS_UPDATE>-FORCURKEY.
   DB_ULN_SBOOK-INVOICE = <FS_UPDATE>-INVOICE.
   DB_ULN_SBOOK-LOCCURAM = <FS_UPDATE>-LOCCURAM.
   DB_ULN_SBOOK-LOCCURKEY = <FS_UPDATE>-LOCCURKEY.
   DB_ULN_SBOOK-LUGGWEIGHT = <FS_UPDATE>-LUGGWEIGHT.
   DB_ULN_SBOOK-ORDER_DATE = <FS_UPDATE>-ORDER_DATE.
   DB_ULN_SBOOK-PASSBIRTH = <FS_UPDATE>-PASSBIRTH.
   DB_ULN_SBOOK-PASSFORM = <FS_UPDATE>-PASSFORM.
   DB_ULN_SBOOK-PASSNAME = <FS_UPDATE>-PASSNAME.
   DB_ULN_SBOOK-RESERVED = <FS_UPDATE>-RESERVED.
   DB_ULN_SBOOK-SMOKER = <FS_UPDATE>-SMOKER.
   DB_ULN_SBOOK-WUNIT = <FS_UPDATE>-WUNIT.


   DB_ULN_SBOOK-BOOKID = <FS_UPDATE>-BOOKID.
   DB_ULN_SBOOK-CARRID = <FS_UPDATE>-CARRID.
   DB_ULN_SBOOK-CONNID = <FS_UPDATE>-CONNID.
   DB_ULN_SBOOK-FLDATE = <FS_UPDATE>-FLDATE.
   append DB_ULN_SBOOK TO DB_UTB_SBOOK.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_SBOOK-BOOKID = <FS_DELETE>-BUSINESS_KEY-BOOKID.
    DB_DLN_SBOOK-CARRID = <FS_DELETE>-BUSINESS_KEY-CARRID.
    DB_DLN_SBOOK-CONNID = <FS_DELETE>-BUSINESS_KEY-CONNID.
    DB_DLN_SBOOK-FLDATE = <FS_DELETE>-BUSINESS_KEY-FLDATE.

    append DB_DLN_SBOOK TO DB_DTB_SBOOK.
...
* * DB Deletes
  delete SBOOK FROM TABLE DB_DTB_SBOOK.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert SBOOK FROM TABLE DB_ITB_SBOOK
...
* * DB Updates
  update SBOOK FROM TABLE DB_UTB_SBOOK.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-BOOKID.
...
*<  Generated from mapping:
  THE_OBJECT->AGENCYNUM = I_OBJECT_DATA-AGENCYNUM.
  THE_OBJECT->BOOKID = I_OBJECT_DATA-BOOKID.
  THE_OBJECT->CANCELLED = I_OBJECT_DATA-CANCELLED.
  THE_OBJECT->CARRID = I_OBJECT_DATA-CARRID.
  THE_OBJECT->CLASS = I_OBJECT_DATA-CLASS.
  THE_OBJECT->CONNID = I_OBJECT_DATA-CONNID.
  THE_OBJECT->COUNTER = I_OBJECT_DATA-COUNTER.
  THE_OBJECT->CUSTOMID = I_OBJECT_DATA-CUSTOMID.
  THE_OBJECT->CUSTTYPE = I_OBJECT_DATA-CUSTTYPE.
  THE_OBJECT->FLDATE = I_OBJECT_DATA-FLDATE.
  THE_OBJECT->FORCURAM = I_OBJECT_DATA-FORCURAM.
  THE_OBJECT->FORCURKEY = I_OBJECT_DATA-FORCURKEY.
  THE_OBJECT->INVOICE = I_OBJECT_DATA-INVOICE.
  THE_OBJECT->LOCCURAM = I_OBJECT_DATA-LOCCURAM.
  THE_OBJECT->LOCCURKEY = I_OBJECT_DATA-LOCCURKEY.
  THE_OBJECT->LUGGWEIGHT = I_OBJECT_DATA-LUGGWEIGHT.
  THE_OBJECT->ORDER_DATE = I_OBJECT_DATA-ORDER_DATE.
  THE_OBJECT->PASSBIRTH = I_OBJECT_DATA-PASSBIRTH.
  THE_OBJECT->PASSFORM = I_OBJECT_DATA-PASSFORM.
  THE_OBJECT->PASSNAME = I_OBJECT_DATA-PASSNAME.
  THE_OBJECT->RESERVED = I_OBJECT_DATA-RESERVED.
  THE_OBJECT->SMOKER = I_OBJECT_DATA-SMOKER.
  THE_OBJECT->WUNIT = I_OBJECT_DATA-WUNIT.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_OO_TUT_PERS_SBOOK.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->BOOKID = I_BUSINESS_KEY-BOOKID.
