class ZCL_OO_TUT_PERS_DEMO definition
  public
  final
  create protected

  global friends ZCB_OO_TUT_PERS_DEMO .

public section.
*"* public components of class ZCL_OO_TUT_PERS_DEMO
...
private section.
*"* private components of class ZCL_OO_TUT_PERS_DEMO
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCL_OO_TUT_PERS_DEMO IMPLEMENTATION.
